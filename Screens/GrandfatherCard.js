...
export default class GrandfatherCard extends Component{
render(){
  return(
    <View>
     <Header 
    ...
    />       
  <Image source = {require('../assets/grandfatherCardImage.png')} style = {{position:'absolute', top:-166,left:-280,width:900,height:900}}/>
