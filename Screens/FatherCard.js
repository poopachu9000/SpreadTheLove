...
export default class FatherCard extends Component{
render(){
  return(
    <View>
     <Header 
    ...
    />       
  <Image source = {require('../assets/dadCardImage.png')} style = {{position:'absolute', top:3,left:-140,width:680,height:680}}/>
