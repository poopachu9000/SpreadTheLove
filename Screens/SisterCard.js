...
export default class SisterCard extends Component{
render(){
  return(
    <View>
     <Header 
    ...
    />       
  <Image source = {require('../assets/sisterCardImage.png')} style = {{position:'absolute', top:106,left:0,width:400,height:400}}/>
